local function show_todos()
	vim.keymap.set(
		"n",
		"<leader>nT",
		[[<cmd>TodoTrouble cwd=/Users/ryan/Library/Mobile\ Documents/iCloud~md~obsidian/Documents/Notes<CR>]],
		{ desc = "[T]odos" }
	)
end
...
return {
	...
	config = function()
		require("obsidian").setup({
			...
			workspaces = {
				{
					name = "sparq",
					path = "/Users/ryan/Library/Mobile Documents/iCloud~md~obsidian/Documents/Notes",
				},
			},
			...
			attachments = {
				...
				img_folder = "assets/imags", -- This is the default
	...
	vim.keymap.set("n", "<leader>ns", "<cmd>ObsidianQuickSwitch<CR>", { desc = "search" }),
	vim.keymap.set("n", "<leader>ng", "<cmd>ObsidianSearch<CR>", { desc = "grep (search text)" }),
