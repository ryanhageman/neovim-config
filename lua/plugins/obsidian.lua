local function show_todos()
  if vim.fn.has("mac") == 1 then
    vim.keymap.set(
      "n",
      "<leader>nT",
      "<cmd>TodoTrouble cwd=/Users/ryan/Dropbox/sparq_notebook<CR>",
      { desc = "[T]odos" }
    )
  else
    vim.keymap.set(
      "n",
      "<leader>nT",
      "<cmd>TodoTrouble cwd=/mnt/c/Users/ryan.hageman/Dropbox/sparq_notebook<CR>",
      { desc = "[T]odos" }
    )
  end
end
      ...
      workspaces = {
        {
          ...
          path = function()
            if vim.fn.has("mac") == 1 then
              return "/Users/ryan/Dropbox/sparq_notebook"
            else
              return "/mnt/c/Users/ryan.hageman/Dropbox/sparq_notebook/"
            end
          end,
        },
      },
